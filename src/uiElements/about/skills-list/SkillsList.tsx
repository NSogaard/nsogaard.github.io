...
/*
 * The SkillList ui element is just a list of SkillElement elements representing all skills that I am comfortable saying that
 * I have proficiency in. It appears in the second half of the "About" page.
 * 
 * Props:
